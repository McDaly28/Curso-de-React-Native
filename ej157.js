...
juegos.forEach(function(iterador){
    if (iterador.localidad === "Capital Federal" && localidadFiltrada === "Capital Federal"){
        iterador.imprimirPantalla();
    }else if (iterador.localidad === "Santa Fe" && localidadFiltrada === "Santa Fe"){
        iterador.imprimirPantalla();
    }else if (iterador.localidad === "Buenos Aires" && localidadFiltrada === "Buenos Aires"){
        iterador.imprimirPantalla();
    }
});
